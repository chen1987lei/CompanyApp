...
@interface NCPracticeLibraryController ()<HomeViewDelegate,TDTitleBarDelegate>
{
    NCLibraryHomeView *mHomeView;
    BOOL _needrefresh;
}
@end

@implementation NCPracticeLibraryController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self.titleBar setTitle:@"资料库"];
...
- (void) initView {
    ...
    if (mHomeView == nil) {
        mHomeView = [[NCLibraryHomeView alloc] initWithFrame:vViewRect];
