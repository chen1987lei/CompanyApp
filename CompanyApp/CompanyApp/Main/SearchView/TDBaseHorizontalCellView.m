...
@implementation TDBaseHorizontalCellView
...
-(void)createView{
    ...
    //默认图
    self.defaultImg=Image(@"Variety_default_map");
    //角标
    ...
    [_imgConner mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(@0);
        make.right.equalTo(weakSelf.imgView.mas_right).offset(0);
    }];
    //腰封
    ...
    [_bottomTitleLab mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(weakSelf.imgView).offset(5);
    }];
